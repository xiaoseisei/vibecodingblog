    ...
    <section id="projects" className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">我的一些个人项目和开源贡献</p>
        </motion.div>
                ...
                <div className="flex gap-3">
                  {project.githubLink && (
                    <a
                      ...
                      className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white transition-colors text-sm"
                    >
                      <Github size={16} />
                      源码
                    </a>
